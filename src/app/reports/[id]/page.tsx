...
export default async function ReportDetailPage({ params }: { params: { id: string } }) {
  ...
  const report = insp as Inspection
  ...
  return (
    <>
      ...
      <main style={{maxWidth:720,margin:'0 auto',padding:'32px 16px 80px'}}>
        <Link href="/reports" className="tag tag-sub" style={{display:'inline-flex',marginBottom:24,cursor:'pointer',alignItems:'center',gap:4}}>← All Reports</Link>
