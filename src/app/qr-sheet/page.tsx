    ...
    <>
      ...
      <main style={{maxWidth:1100,margin:'0 auto',padding:'36px 20px 60px'}}>
        <div style={{marginBottom:36}}>
          ...
          <h1 style={{fontSize:'clamp(22px,4vw,32px)',fontWeight:800,letterSpacing:'-0.5px',lineHeight:1.1}}>Fire Extinguisher QR Sheet</h1>
          <p style={{color:'var(--sub)',fontFamily:'DM Mono, monospace',fontSize:13,marginTop:8}}>{extinguishers?.length ?? 0} units · Print and post each card near its unit</p>
        </div>
